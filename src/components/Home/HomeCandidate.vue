            ...
            <div class="row justify-content-between text-white g-5">
                <div class="col-md-5">
                    <div class="p-3 d-grid">
                        ...
                        <p>When you find a new job with an IT staffing service, you can assume that you will land a job
                ...
                <div class="col-md-5">
                    <div class="p-3 d-grid">
                        ...
                        <p>Their ambitions, company culture and what they are really looking for in a candidate. We
